function [nll,d,H,model] = RevLearn_RLcoh_2lr_cfa(param,data, pps)
%
...
if strcmp(pps, 'mle')
    ...
    cfa  = param(3); % cfa
    coha = param(4); % coherence weight for majority against choice1
    cohw = param(5); % coherence weight for majority with choice1
...
if nargout > 3
  ...
  model.pnames = {'lr1','lr2', 'cfa', 'coh_against','coh_with','temp'};
  model.param  = param;
  model.data   = data;
  model.v      = v;
  model.pe     = pe;
